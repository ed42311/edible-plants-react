...
import { IUserFormBody } from 'typings'
 ...
 *
 */
function validateSignupForm(payload: IUserFormBody) {
  const errors = {} as IUserFormBody
 ...
 *
 */
function validateLoginForm(payload: IUserFormBody) {
  const errors = {} as IUserFormBody
  let isFormValid = true
  let message = ''
